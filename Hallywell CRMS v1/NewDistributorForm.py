...
class Ui_NewDistributorForm(object):
    def setupUi(self, NewDistributorForm):
        ...
        NewDistributorForm.resize(1162, 660)
...
"QScrollBar{background: black;}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1119, 654))
...
"QPushButton::hover{border:2px solid white; background-color:#F27E14; color:white;}")
    ...
    def retranslateUi(self, NewDistributorForm):
        ...
        self.Form_Name_2.setText(_translate("NewDistributorForm", "<html><head/><body><p><span style=\" font-weight:600;\">New Distributor</span> Form</p></body></html>"))
