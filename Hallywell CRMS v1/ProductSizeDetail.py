# Form implementation generated from reading ui file 'ProductSizeDetail.ui'
#
...
class Ui_ProductSizeDetail(object):
    def setupUi(self, ProductSizeDetail):
        ProductSizeDetail.setObjectName("ProductSizeDetail")
        ProductSizeDetail.resize(824, 500)
        ProductSizeDetail.setStyleSheet("background-color:#D0DBE8")
        self.centralwidget = QtWidgets.QWidget(ProductSizeDetail)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 802, 478))
...
"QLineEdit::hover{border-radius: 0;}")
        ...
        ProductSizeDetail.setCentralWidget(self.centralwidget)

        self.retranslateUi(ProductSizeDetail)
        QtCore.QMetaObject.connectSlotsByName(ProductSizeDetail)

    def retranslateUi(self, ProductSizeDetail):
        _translate = QtCore.QCoreApplication.translate
        ProductSizeDetail.setWindowTitle(_translate("ProductSizeDetail", "Product Size Details"))
        self.label_2.setText(_translate("ProductSizeDetail", "<strong>Product</strong> Size Details"))
        self.label_title.setText(_translate("ProductSizeDetail", "<strong>HallyWell</strong> \n"
"Linen Company"))
        self.label.setText(_translate("ProductSizeDetail", "Add New Size"))
        self.addButton.setText(_translate("ProductSizeDetail", "Add Size"))
        self.lineEdit_new.setPlaceholderText(_translate("ProductSizeDetail", "Enter New Size"))
        self.label_3.setText(_translate("ProductSizeDetail", "OR"))
...
if __name__ == "__main__":
    ...
    ProductSizeDetail = QtWidgets.QMainWindow()
    ui = Ui_ProductSizeDetail()
    ui.setupUi(ProductSizeDetail)
    ProductSizeDetail.show()
    sys.exit(app.exec())
