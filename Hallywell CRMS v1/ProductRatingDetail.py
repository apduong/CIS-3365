...
class Ui_ProductRatingDetail(object):
    def setupUi(self, ProductRatingDetail):
        ...
        ProductRatingDetail.resize(852, 489)
...
"QLineEdit::hover{border-radius: 0;}")
    ...
    def retranslateUi(self, ProductRatingDetail):
        ...
        self.Form_Name.setText(_translate("ProductRatingDetail", "<strong>Product</strong> Rating Details"))
        self.label_title.setText(_translate("ProductRatingDetail", "<strong>HallyWell</strong> \n"
"Linen Company"))
        self.label.setText(_translate("ProductRatingDetail", "Add New Rating"))
        self.addButton.setText(_translate("ProductRatingDetail", "Add Rating"))
        self.lineEdit_new.setPlaceholderText(_translate("ProductRatingDetail", "Enter New Rating"))
        self.label_3.setText(_translate("ProductRatingDetail", "OR"))
        self.label_5.setText(_translate("ProductRatingDetail", "Rating Description"))
        self.label_4.setText(_translate("ProductRatingDetail", "Select Rating to Edit"))
        self.lineEdit_desc.setPlaceholderText(_translate("ProductRatingDetail", "Rating Description Here"))
        self.updateButton.setText(_translate("ProductRatingDetail", "Update Rating"))
        self.deleteButton.setText(_translate("ProductRatingDetail", "Delete Rating"))
