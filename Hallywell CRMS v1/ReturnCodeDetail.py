# Form implementation generated from reading ui file 'ReturnCodeDetail.ui'
#
...
class Ui_ReturnCodeStatus(object):
    def setupUi(self, ReturnCodeStatus):
        ReturnCodeStatus.setObjectName("ReturnCodeStatus")
        ReturnCodeStatus.resize(824, 500)
        ReturnCodeStatus.setStyleSheet("background-color:#D0DBE8")
        self.centralwidget = QtWidgets.QWidget(ReturnCodeStatus)
...
"QLineEdit::hover{border-radius: 0;}")
        ...
        self.lineEdit_EnterNewID = QtWidgets.QLineEdit(self.frame_3)
        self.lineEdit_EnterNewID.setMinimumSize(QtCore.QSize(200, 25))
        self.lineEdit_EnterNewID.setMaximumSize(QtCore.QSize(210, 25))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(9)
        self.lineEdit_EnterNewID.setFont(font)
        self.lineEdit_EnterNewID.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.ArrowCursor))
        self.lineEdit_EnterNewID.setMaxLength(20)
        self.lineEdit_EnterNewID.setAlignment(QtCore.Qt.Alignment.AlignCenter)
        self.lineEdit_EnterNewID.setObjectName("lineEdit_EnterNewID")
        self.gridLayout.addWidget(self.lineEdit_EnterNewID, 3, 0, 1, 1)
        ...
        self.lineEdit_IDDescription = QtWidgets.QLineEdit(self.frame_4)
        self.lineEdit_IDDescription.setMinimumSize(QtCore.QSize(210, 25))
        self.lineEdit_IDDescription.setMaximumSize(QtCore.QSize(210, 25))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(9)
        self.lineEdit_IDDescription.setFont(font)
        self.lineEdit_IDDescription.setMaxLength(20)
        self.lineEdit_IDDescription.setAlignment(QtCore.Qt.Alignment.AlignCenter)
        self.lineEdit_IDDescription.setObjectName("lineEdit_IDDescription")
        self.gridLayout_2.addWidget(self.lineEdit_IDDescription, 2, 1, 1, 1)
        self.comboBox_SelectID = QtWidgets.QComboBox(self.frame_4)
        self.comboBox_SelectID.setMinimumSize(QtCore.QSize(210, 0))
        self.comboBox_SelectID.setMaximumSize(QtCore.QSize(210, 16777215))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(9)
        self.comboBox_SelectID.setFont(font)
        self.comboBox_SelectID.setObjectName("comboBox_SelectID")
        self.gridLayout_2.addWidget(self.comboBox_SelectID, 0, 1, 1, 1)
        ...
        ReturnCodeStatus.setCentralWidget(self.centralwidget)

        self.retranslateUi(ReturnCodeStatus)
        QtCore.QMetaObject.connectSlotsByName(ReturnCodeStatus)

    def retranslateUi(self, ReturnCodeStatus):
        _translate = QtCore.QCoreApplication.translate
        ReturnCodeStatus.setWindowTitle(_translate("ReturnCodeStatus", "ReturnCodeStatus"))
        self.label_2.setText(_translate("ReturnCodeStatus", "<html><head/><body><p><span style=\" font-weight:600;\">Return Code</span> Details</p></body></html>"))
        self.label_title.setText(_translate("ReturnCodeStatus", "<strong>HallyWell</strong> \n"
"Linen Company"))
        self.label.setText(_translate("ReturnCodeStatus", "Add New ID"))
        self.addButton.setText(_translate("ReturnCodeStatus", "Add ID"))
        self.lineEdit_EnterNewID.setPlaceholderText(_translate("ReturnCodeStatus", "Enter New ID"))
        self.label_3.setText(_translate("ReturnCodeStatus", "OR"))
        self.label_5.setText(_translate("ReturnCodeStatus", "ID Description"))
        self.label_4.setText(_translate("ReturnCodeStatus", "Select ID to Edit"))
        self.lineEdit_IDDescription.setPlaceholderText(_translate("ReturnCodeStatus", "ID Description Here"))
        self.updateButton.setText(_translate("ReturnCodeStatus", "Update ID"))
        self.deleteButton.setText(_translate("ReturnCodeStatus", "Delete ID"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    ReturnCodeStatus = QtWidgets.QMainWindow()
    ui = Ui_ReturnCodeStatus()
    ui.setupUi(ReturnCodeStatus)
    ReturnCodeStatus.show()
    sys.exit(app.exec())
