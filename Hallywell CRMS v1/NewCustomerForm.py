...
"QScrollBar{background: black;}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1935, 707))
...
"    font: 75 18pt \"Arial\";")
        ...
        self.comboBox.setMinimumSize(QtCore.QSize(900, 25))
        self.comboBox.setMaximumSize(QtCore.QSize(900, 25))
...
"Linen Company"))
        ...
        self.lineEdit_primNum.setText(_translate("NewCustomerForm", "() -"))
        ...
        self.label_23.setText(_translate("NewCustomerForm", "*"))
