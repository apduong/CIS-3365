...
class Ui_NewEmployeeForm(object):
    def setupUi(self, NewEmployeeForm):
        ...
        NewEmployeeForm.resize(951, 714)
...
"QPushButton::hover{border:2px solid white; background-color:#F27E14; color:white;}")
    ...
    def retranslateUi(self, NewEmployeeForm):
        ...
        self.Form_Name_2.setText(_translate("NewEmployeeForm", "<html><head/><body><p>New Employee</p></body></html>"))
...
"Linen Company"))
        ...
        self.label_11.setText(_translate("NewEmployeeForm", "Date of Birth"))
        self.lineEdit_DateOfBirth.setPlaceholderText(_translate("NewEmployeeForm", "Enter Birthdate"))
        self.lineEdit_PostalCode.setPlaceholderText(_translate("NewEmployeeForm", "Enter Postal"))
