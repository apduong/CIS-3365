...
"QScrollBar{background: black;}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 931, 510))
...
"")
        ...
        self.lineEdit_DisCN.setMinimumSize(QtCore.QSize(230, 25))
        self.lineEdit_DisCN.setMaximumSize(QtCore.QSize(230, 25))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(8)
...
"QPushButton::hover{border:2px solid white; background-color:#F27E14; color:white;}")
    ...
    def retranslateUi(self, DistributorContactForm):
        ...
        self.DisContact.setText(_translate("DistributorContactForm", "<strong> Distributor</strong> Contact"))
...
"Linen Company"))
        ...
        self.lineEdit_DisCN.setPlaceholderText(_translate("DistributorContactForm", "Enter Contact Number (no spaces)"))
        ...
        self.lineEdit_email.setPlaceholderText(_translate("DistributorContactForm", "Enter valid email address"))
