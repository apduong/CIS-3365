...
class Ui_OrderStatus(object):
    def setupUi(self, OrderStatus):
        OrderStatus.setObjectName("OrderStatus")
        OrderStatus.resize(824, 500)
        OrderStatus.setStyleSheet("background-color:#D0DBE8")
        self.centralwidget = QtWidgets.QWidget(OrderStatus)
...
"QLineEdit::hover{border-radius: 0;}")
        ...
        sizePolicy.setHeightForWidth(self.lineEdit_EnterNewStatus.sizePolicy().hasHeightForWidth())
        self.lineEdit_EnterNewStatus.setSizePolicy(sizePolicy)
        ...
        self.lineEdit_EnterNewStatus.setMaxLength(50)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lineEdit_StatusDescription.sizePolicy().hasHeightForWidth())
        self.lineEdit_StatusDescription.setSizePolicy(sizePolicy)
        ...
        self.lineEdit_StatusDescription.setMaxLength(50)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.comboBox_SelectStatus.sizePolicy().hasHeightForWidth())
        self.comboBox_SelectStatus.setSizePolicy(sizePolicy)
        ...
        OrderStatus.setCentralWidget(self.centralwidget)

        self.retranslateUi(OrderStatus)
        QtCore.QMetaObject.connectSlotsByName(OrderStatus)

    def retranslateUi(self, OrderStatus):
        _translate = QtCore.QCoreApplication.translate
        OrderStatus.setWindowTitle(_translate("OrderStatus", "Order Status"))
        self.label_2.setText(_translate("OrderStatus", "<html><head/><body><p><span style=\" font-weight:600;\">Orders</span> Status Details</p></body></html>"))
        self.label_title.setText(_translate("OrderStatus", "<strong>HallyWell</strong> \n"
"Linen Company"))
        self.label.setText(_translate("OrderStatus", "Add New Status"))
        self.addButton.setText(_translate("OrderStatus", "Add Status"))
        self.lineEdit_EnterNewStatus.setPlaceholderText(_translate("OrderStatus", "Enter New Status"))
        self.label_3.setText(_translate("OrderStatus", "OR"))
        self.label_5.setText(_translate("OrderStatus", "Status Description"))
        self.label_4.setText(_translate("OrderStatus", "Select Status to Edit"))
        self.lineEdit_StatusDescription.setPlaceholderText(_translate("OrderStatus", "Status Description Here"))
        self.updateButton.setText(_translate("OrderStatus", "Update Status"))
        self.deleteButton.setText(_translate("OrderStatus", "Delete Status"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    OrderStatus = QtWidgets.QMainWindow()
    ui = Ui_OrderStatus()
    ui.setupUi(OrderStatus)
    OrderStatus.show()
    sys.exit(app.exec())
