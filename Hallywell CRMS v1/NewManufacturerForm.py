...
"")
        ...
        self.lineEdit_number.setMinimumSize(QtCore.QSize(175, 25))
        self.lineEdit_number.setMaximumSize(QtCore.QSize(150, 25))
        self.lineEdit_number.setMaxLength(25)
        self.lineEdit_number.setObjectName("lineEdit_number")
        self.gridLayout_2.addWidget(self.lineEdit_number, 3, 2, 1, 1)
        ...
        self.lineEdit_email.setMinimumSize(QtCore.QSize(350, 25))
        self.lineEdit_email.setMaximumSize(QtCore.QSize(350, 25))
        ...
        self.comboBox_status.setMinimumSize(QtCore.QSize(170, 25))
        self.comboBox_status.setMaximumSize(QtCore.QSize(170, 25))
        self.comboBox_status.setObjectName("comboBox_status")
        self.gridLayout_2.addWidget(self.comboBox_status, 5, 2, 1, 1)
        self.lineEdit_man_name = QtWidgets.QLineEdit(self.frame_4)
        self.lineEdit_man_name.setMinimumSize(QtCore.QSize(400, 25))
        self.lineEdit_man_name.setMaximumSize(QtCore.QSize(400, 25))
        self.lineEdit_man_name.setMaxLength(50)
        ...
        self.gridLayout_2.addWidget(self.lineEdit_man_name, 0, 2, 1, 1)
        self.lineEdit_man_address = QtWidgets.QLineEdit(self.frame_4)
        self.lineEdit_man_address.setMinimumSize(QtCore.QSize(700, 25))
        self.lineEdit_man_address.setMaximumSize(QtCore.QSize(700, 25))
        self.lineEdit_man_address.setMaxLength(250)
        self.lineEdit_man_address.setObjectName("lineEdit_man_address")
        self.gridLayout_2.addWidget(self.lineEdit_man_address, 1, 2, 1, 1)
...
"    font: 75 18pt \"Arial\";")
        ...
        self.label_10.setStyleSheet("background: none; color:red; font-weight: bold; \n"
"    font: 75 18pt \"Arial\";")
...
"QPushButton::hover{border:2px solid white; background-color:#F27E14; color:white;}")
    ...
    def retranslateUi(self, NewManufacturerForm):
        ...
        self.Form_Name_2.setText(_translate("NewManufacturerForm", "New <strong>Manufacturer</strong>"))
...
"Linen Company"))
        ...
        self.lineEdit_number.setPlaceholderText(_translate("NewManufacturerForm", "Enter Phone Number"))
        self.label_4.setText(_translate("NewManufacturerForm", "Email"))
        self.label_DisName.setText(_translate("NewManufacturerForm", "Name"))
        self.lineEdit_email.setPlaceholderText(_translate("NewManufacturerForm", "Enter Valid Email"))
        self.label_DisDesc.setText(_translate("NewManufacturerForm", "Manufacturer Status"))
        self.lineEdit_man_name.setPlaceholderText(_translate("NewManufacturerForm", "Enter Manufacturer Name"))
        self.lineEdit_man_address.setPlaceholderText(_translate("NewManufacturerForm", "Enter Adress"))
        self.label_DisAddress.setText(_translate("NewManufacturerForm", "Address"))
        self.label_6.setText(_translate("NewManufacturerForm", "*"))
        self.label_7.setText(_translate("NewManufacturerForm", "*"))
        self.label_8.setText(_translate("NewManufacturerForm", "*"))
        self.label_9.setText(_translate("NewManufacturerForm", "*"))
        self.label_10.setText(_translate("NewManufacturerForm", "*"))
