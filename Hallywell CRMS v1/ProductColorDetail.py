# Form implementation generated from reading ui file 'ProductColorDetail.ui'
#
...
class Ui_ProductColorDetail(object):
    def setupUi(self, ProductColorDetail):
        ProductColorDetail.setObjectName("ProductColorDetail")
        ProductColorDetail.resize(827, 489)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("hallywell_icon.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ProductColorDetail.setWindowIcon(icon)
        ProductColorDetail.setStyleSheet("background-color:#D0DBE8")
        self.centralwidget = QtWidgets.QWidget(ProductColorDetail)
...
"")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 805, 467))
...
"QLineEdit::hover{border-radius: 0;}")
        ...
        ProductColorDetail.setCentralWidget(self.centralwidget)

        self.retranslateUi(ProductColorDetail)
        QtCore.QMetaObject.connectSlotsByName(ProductColorDetail)

    def retranslateUi(self, ProductColorDetail):
        _translate = QtCore.QCoreApplication.translate
        ProductColorDetail.setWindowTitle(_translate("ProductColorDetail", "Product Color Details"))
        self.Form_Name.setText(_translate("ProductColorDetail", "<strong>Product</strong> Color Details"))
        self.label_title.setText(_translate("ProductColorDetail", "<strong>HallyWell</strong> \n"
"Linen Company"))
        self.label.setText(_translate("ProductColorDetail", "Add New Color"))
        self.addButton.setText(_translate("ProductColorDetail", "Add Color"))
        self.lineEdit_new.setPlaceholderText(_translate("ProductColorDetail", "Enter New Color"))
        self.label_3.setText(_translate("ProductColorDetail", "OR"))
        self.label_5.setText(_translate("ProductColorDetail", "Color Description"))
        self.label_4.setText(_translate("ProductColorDetail", "Select Color to Edit"))
        self.lineEdit_desc.setPlaceholderText(_translate("ProductColorDetail", "Color Description Here"))
        self.updateButton.setText(_translate("ProductColorDetail", "Update Color"))
        self.deleteButton.setText(_translate("ProductColorDetail", "Delete Color"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    ProductColorDetail = QtWidgets.QMainWindow()
    ui = Ui_ProductColorDetail()
    ui.setupUi(ProductColorDetail)
    ProductColorDetail.show()
    sys.exit(app.exec())
