...
class Ui_ProductColorDetail(object):
    def setupUi(self, ProductColorDetail):
        ...
        ProductColorDetail.resize(815, 429)
...
"")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 793, 407))
...
"QPushButton::hover{border: solid black; background-color:white;}")
    ...
    def retranslateUi(self, ProductColorDetail):
        ...
        self.Form_Name.setText(_translate("ProductColorDetail", "Product Color Details"))
        self.label_2.setText(_translate("ProductColorDetail", "OR"))
        self.label.setText(_translate("ProductColorDetail", "Select Color to Edit"))
        self.add_button.setText(_translate("ProductColorDetail", "Add Color"))
        self.label_3.setText(_translate("ProductColorDetail", "Add New Color"))
        self.label_4.setText(_translate("ProductColorDetail", "Color Description"))
        self.update_button.setText(_translate("ProductColorDetail", "Update Color"))
        self.save_Button.setText(_translate("ProductColorDetail", "Save Changes"))
        self.delete_Button.setText(_translate("ProductColorDetail", "Delete Color"))
