# Form implementation generated from reading ui file 'ProductStatusDetail.ui'
#
...
class Ui_ProductStatusDetail(object):
    def setupUi(self, ProductStatusDetail):
        ProductStatusDetail.setObjectName("ProductStatusDetail")
        ProductStatusDetail.resize(852, 489)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("hallywell_icon.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ProductStatusDetail.setWindowIcon(icon)
        ProductStatusDetail.setStyleSheet("background-color:#D0DBE8")
        self.centralwidget = QtWidgets.QWidget(ProductStatusDetail)
...
"QLineEdit::hover{border-radius: 0;}")
        ...
        ProductStatusDetail.setCentralWidget(self.centralwidget)

        self.retranslateUi(ProductStatusDetail)
        QtCore.QMetaObject.connectSlotsByName(ProductStatusDetail)

    def retranslateUi(self, ProductStatusDetail):
        _translate = QtCore.QCoreApplication.translate
        ProductStatusDetail.setWindowTitle(_translate("ProductStatusDetail", "Product Status Details"))
        self.Form_Name.setText(_translate("ProductStatusDetail", "<html><head/><body><p><span style=\" font-weight:600;\">Product</span> Status Details</p></body></html>"))
        self.label_title.setText(_translate("ProductStatusDetail", "<strong>HallyWell</strong> \n"
"Linen Company"))
        self.label.setText(_translate("ProductStatusDetail", "Add New Status"))
        self.addButton.setText(_translate("ProductStatusDetail", "Add Status"))
        self.lineEdit_new.setPlaceholderText(_translate("ProductStatusDetail", "Enter New Status"))
        self.label_3.setText(_translate("ProductStatusDetail", "OR"))
        self.label_5.setText(_translate("ProductStatusDetail", "Status Description"))
        self.label_4.setText(_translate("ProductStatusDetail", "Select Status to Edit"))
        self.lineEdit_desc.setPlaceholderText(_translate("ProductStatusDetail", "Status Description Here"))
        self.updateButton.setText(_translate("ProductStatusDetail", "Update Status"))
        self.deleteButton.setText(_translate("ProductStatusDetail", "Delete Status"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    ProductStatusDetail = QtWidgets.QMainWindow()
    ui = Ui_ProductStatusDetail()
    ui.setupUi(ProductStatusDetail)
    ProductStatusDetail.show()
    sys.exit(app.exec())
