...
class Ui_ProductStatusDetail(object):
    def setupUi(self, ProductStatusDetail):
        ...
        ProductStatusDetail.resize(845, 444)
...
"QPushButton::hover{border: solid black; background-color:white;}")
    ...
    def retranslateUi(self, ProductStatusDetail):
        ...
        self.Form_Name.setText(_translate("ProductStatusDetail", "Product Status Details"))
        self.label_2.setText(_translate("ProductStatusDetail", "OR"))
        self.label.setText(_translate("ProductStatusDetail", "Select Status to Edit"))
        self.add_button.setText(_translate("ProductStatusDetail", "Add Status"))
        self.label_3.setText(_translate("ProductStatusDetail", "Add New Status"))
        self.label_4.setText(_translate("ProductStatusDetail", "Status Description"))
        self.update_button.setText(_translate("ProductStatusDetail", "Update Status"))
        self.save_Button.setText(_translate("ProductStatusDetail", "Save Changes"))
        self.delete_Button.setText(_translate("ProductStatusDetail", "Delete Status"))
