# Form implementation generated from reading ui file 'NewManufacturerContact.ui'
#
...
class Ui_NewManufacturerContact(object):
    def setupUi(self, NewManufacturerContact):
        NewManufacturerContact.setObjectName("NewManufacturerContact")
        NewManufacturerContact.resize(953, 628)
        NewManufacturerContact.setStyleSheet("background-color:#D0DBE8;")
        self.centralwidget = QtWidgets.QWidget(NewManufacturerContact)
...
"")
        ...
        self.comboBox_manu.setMinimumSize(QtCore.QSize(300, 25))
        self.comboBox_manu.setMaximumSize(QtCore.QSize(300, 25))
...
"QPushButton::hover{border:2px solid white; background-color:#F27E14; color:white;}")
        ...
        NewManufacturerContact.setCentralWidget(self.centralwidget)

        self.retranslateUi(NewManufacturerContact)
        QtCore.QMetaObject.connectSlotsByName(NewManufacturerContact)

    def retranslateUi(self, NewManufacturerContact):
        _translate = QtCore.QCoreApplication.translate
        NewManufacturerContact.setWindowTitle(_translate("NewManufacturerContact", "New Manufacturer Contact"))
        self.DisContact.setText(_translate("NewManufacturerContact", "<html><head/><body><p>New Manufacturer Contact </p></body></html>"))
        self.label_title.setText(_translate("NewManufacturerContact", "<strong>HallyWell</strong> \n"
"Linen Company"))
        self.label_4.setText(_translate("NewManufacturerContact", "Please fill out all required and applicable information."))
        self.label_5.setText(_translate("NewManufacturerContact", "*"))
        self.label_6.setText(_translate("NewManufacturerContact", "- required fields"))
        self.label_7.setText(_translate("NewManufacturerContact", "Manufacturer Name"))
        self.lineEdit_email.setPlaceholderText(_translate("NewManufacturerContact", "Enter Email Address"))
        self.label_2.setText(_translate("NewManufacturerContact", "Email"))
        self.lineEdit_DisName.setPlaceholderText(_translate("NewManufacturerContact", "First and Last Name"))
        self.label_DisCN.setText(_translate("NewManufacturerContact", "Contact Number"))
        self.lineEdit_DisCN.setPlaceholderText(_translate("NewManufacturerContact", "Enter Contact Number"))
        self.label_DisName.setText(_translate("NewManufacturerContact", "Name"))
        self.label.setText(_translate("NewManufacturerContact", "*"))
        self.label_3.setText(_translate("NewManufacturerContact", "*"))
        self.label_8.setText(_translate("NewManufacturerContact", "*"))
        self.label_9.setText(_translate("NewManufacturerContact", "*"))
        self.save_Button_DC.setText(_translate("NewManufacturerContact", "Submit Form"))
        self.delete_Button_DC.setText(_translate("NewManufacturerContact", "Clear Form"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    NewManufacturerContact = QtWidgets.QMainWindow()
    ui = Ui_NewManufacturerContact()
    ui.setupUi(NewManufacturerContact)
    NewManufacturerContact.show()
    sys.exit(app.exec())
