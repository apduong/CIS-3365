...
class Ui_ProductTypeDetail(object):
    def setupUi(self, ProductTypeDetail):
        ...
        ProductTypeDetail.resize(815, 429)
...
"QPushButton::hover{border: solid black; background-color:white;}")
    ...
    def retranslateUi(self, ProductTypeDetail):
        ...
        self.Form_Name.setText(_translate("ProductTypeDetail", "Product Type Detail"))
        self.label_2.setText(_translate("ProductTypeDetail", "OR"))
        self.label.setText(_translate("ProductTypeDetail", "Select Type to Edit"))
        self.add_button.setText(_translate("ProductTypeDetail", "Add Type"))
        self.label_3.setText(_translate("ProductTypeDetail", "Add New Type"))
        self.label_4.setText(_translate("ProductTypeDetail", "Type Description"))
        self.update_button.setText(_translate("ProductTypeDetail", "Update Type"))
        self.save_Button.setText(_translate("ProductTypeDetail", "Save Changes"))
        self.delete_Button.setText(_translate("ProductTypeDetail", "Delete Type"))
