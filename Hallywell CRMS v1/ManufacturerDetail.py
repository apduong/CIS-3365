# Form implementation generated from reading ui file 'ManufacturerDetail.ui'
#
...
class Ui_ManufacturerStatus(object):
    def setupUi(self, ManufacturerStatus):
        ManufacturerStatus.setObjectName("ManufacturerStatus")
        ManufacturerStatus.resize(824, 500)
        ManufacturerStatus.setStyleSheet("background-color:#D0DBE8")
        self.centralwidget = QtWidgets.QWidget(ManufacturerStatus)
...
"QLineEdit::hover{border-radius: 0;}")
        ...
        ManufacturerStatus.setCentralWidget(self.centralwidget)

        self.retranslateUi(ManufacturerStatus)
        QtCore.QMetaObject.connectSlotsByName(ManufacturerStatus)

    def retranslateUi(self, ManufacturerStatus):
        _translate = QtCore.QCoreApplication.translate
        ManufacturerStatus.setWindowTitle(_translate("ManufacturerStatus", "ManufacturerStatus"))
        self.label_2.setText(_translate("ManufacturerStatus", "<html><head/><body><p><span style=\" font-weight:600;\">Manufacturer</span> Status Details</p></body></html>"))
        self.label_title.setText(_translate("ManufacturerStatus", "<strong>HallyWell</strong> \n"
"Linen Company"))
        self.label.setText(_translate("ManufacturerStatus", "Add New Status"))
        self.addButton.setText(_translate("ManufacturerStatus", "Add Status"))
        self.lineEdit_EnterNewStatus.setPlaceholderText(_translate("ManufacturerStatus", "Enter New Status"))
        self.label_3.setText(_translate("ManufacturerStatus", "OR"))
        self.label_5.setText(_translate("ManufacturerStatus", "Status Description"))
        self.label_4.setText(_translate("ManufacturerStatus", "Select Status to Edit"))
        self.lineEdit_StatusDescription.setPlaceholderText(_translate("ManufacturerStatus", "Status Description Here"))
        self.updateButton.setText(_translate("ManufacturerStatus", "Update Status"))
        self.deleteButton.setText(_translate("ManufacturerStatus", "Delete Status"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    ManufacturerStatus = QtWidgets.QMainWindow()
    ui = Ui_ManufacturerStatus()
    ui.setupUi(ManufacturerStatus)
    ManufacturerStatus.show()
    sys.exit(app.exec())
